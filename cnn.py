...
train_path = '/root/intelcaffe/data/kaggle/cat_dog/train'
test_path = '/root/intelcaffe/data/kaggle/cat_dog/test1'
checkpoint_dir = "."
...
def optimize(num_iterations):
	...
	images_test_total = data.valid.images[:, :].reshape(data.valid.images[:, :].shape[0], img_size_flat)
